...
function Invoke-AgentIntegrationTests {
    ...
    Write-Output "Starting SimRacing Agent Integration Tests"
    Write-Output "========================================="
    Write-Output ""

    try {
        foreach ($suite in $TestSuites) {
            Write-Output "Running agent integration test suite: $suite"
            ...
            if (-not $result.Success) {
                ...
                if ($StopOnFirstFailure) {
                    Write-Error "Stopping agent integration tests due to failure in $suite"
                    break
                }
            }
        ...
        Write-Output "Agent Integration Test Summary"
        Write-Output "=============================="
