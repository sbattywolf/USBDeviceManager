...
namespace USBDeviceManager.Controllers
{
    ...
    public class CompatController : ControllerBase
    {
        ...
        /// <summary>
        /// Lists compatibility configuration objects composed from devices, software and automation rules.
        /// </summary>
        /// <returns>A <see cref="Task"/> producing an <see cref="IActionResult"/> with the combined configs.</returns>
        [HttpGet("configs")]
        ...
        /// <summary>
        /// Creates a device, software and automation rule from the compatibility configuration payload.
        /// </summary>
        /// <param name="input">Configuration DTO containing device and software fields.</param>
        /// <returns>A <see cref="Task"/> producing an <see cref="IActionResult"/> for the created resource or error.</returns>
        [HttpPost("configs")]
        ...
        /// <summary>
        /// Returns recent device and software status entries normalized to a simple log shape.
        /// </summary>
        /// <returns>A <see cref="Task"/> producing an <see cref="IActionResult"/> with the log entries.</returns>
        [HttpGet("logs")]
        ...
        /// <summary>
        /// Accepts a client log payload and stores it as a device status entry when possible.
        /// </summary>
        /// <param name="payload">Arbitrary JSON payload sent by clients.</param>
        /// <returns>A <see cref="Task"/> producing an <see cref="IActionResult"/> indicating result.</returns>
        [HttpPost("logs")]
        ...
        /// <summary>
        /// Serves the agent installation script file when available, or a small placeholder script when missing.
        /// </summary>
        /// <returns>An <see cref="IActionResult"/> containing the agent file or a placeholder response.</returns>
